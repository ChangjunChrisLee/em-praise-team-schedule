...
import { Users, AlertTriangle, RotateCcw, ClipboardCopy, Plus, RefreshCw } from "lucide-react";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      try { setSyncStatus("Google Sheet에 저장 중..."); await saveRemoteData(dataToSave); setSyncStatus("Google Sheet에 저장됨"); }
      catch { setSyncStatus("Google Sheet 저장 실패"); }
    }, 500);
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            <div className="rounded-xl bg-white px-3 py-2 text-xs text-slate-500 shadow-sm">{syncStatus}</div>
